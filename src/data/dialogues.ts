  ...
  // ─── Chapter 1 ─────────────────────────────────────────────────────────────
  {
    ...
    slides: [
      ...
      },
      {
        ...
        text: '飲み物を作るのはもちろん、お客様との会話や雰囲気作りも大事なんですね。',
      },
      {
        speaker: 'master' as const,
        expression: 'happy' as const,
        text: '覚えが早いね。プロのバーテンダーは「ホスピタリティ」の塊だ。では基礎から一つ一つ学んでいこう。最初は確認テストをしてもらうよ。',
        highlight: 'ホスピタリティ',
      },
    ],
  },
  {
    ...
    slides: [
      ...
      },
      {
        speaker: 'master' as const,
        expression: 'happy' as const,
        text: 'まずは「シェーカー」だ。材料を振り混ぜて冷やすための道具で、バーテンダーの象徴とも言える。三つのパーツ——ボディ、ストレーナー、キャップ——から成る。',
        highlight: 'シェーカー',
        visual: 'shaker',
      },
      {
        speaker: 'master' as const,
        expression: 'normal' as const,
        text: '次に「バースプーン」だ。長い柄を持つスプーンで、ステアの際にグラスの中で材料を混ぜる。柄をひねりながら使うのがコツだ。',
        highlight: 'バースプーン',
        visual: 'bar_spoon',
      },
      {
      ...
      },
      {
        speaker: 'master' as const,
        expression: 'normal' as const,
        text: '「メジャーカップ」はジガーとも呼ばれ、材料の量を正確に計るための道具だ。通常30mlと45mlの両端がある。正確な計量がおいしいカクテルの基本だよ。',
        highlight: 'メジャーカップ',
        visual: 'jigger',
      },
      {
        speaker: 'master' as const,
        expression: 'strict' as const,
        text: '他にもミキシンググラス、マドラー、アイスピック、ペストル、ストレーナーなど多くの道具がある。それぞれの用途を覚えることが重要だ。',
        highlight: 'ミキシンググラス',
        visual: 'mixing_glass',
      },
    ],
    ...
    slides: [
      {
        speaker: 'master' as const,
        expression: 'normal' as const,
        text: '今日はグラスについて学ぼう。カクテルの見た目と味わいに大きく影響する、大切な要素だ。',
        highlight: 'グラス',
      },
      {
        speaker: 'master' as const,
        expression: 'happy' as const,
        text: 'まず「カクテルグラス」——逆三角形の脚付きグラスで、マティーニなど冷たいカクテルに使う。足の長いデザインで手の温度が飲み物に伝わりにくいという利点がある。',
        highlight: 'カクテルグラス',
        visual: 'cocktail',
      },
      {
        speaker: 'master' as const,
        expression: 'normal' as const,
        text: '「ロックグラス」はオールドファッションドグラスとも言い、背が低くどっしりとしたグラスだ。氷を入れてウイスキーを飲む際や、ロングカクテルにも使われる。',
        highlight: 'ロックグラス',
        visual: 'rocks',
      },
      {
      ...
      },
      {
        speaker: 'master' as const,
        expression: 'normal' as const,
        text: 'いい質問だ。「ハイボールグラス」は200〜300ml程度の細長いグラスで、ハイボールや炭酸飲料のカクテルに使う。「コリンズグラス」はさらに背が高く細長く、容量も多い。トムコリンズなどのロングカクテル用だ。',
        highlight: 'ハイボールグラス',
        visual: 'highball',
      },
      {
        speaker: 'master' as const,
        expression: 'happy' as const,
        text: '他にもシャンパンフルート、マルガリータグラス、ショットグラス、ワイングラスなど様々ある。グラス選びもバーテンダーの腕の見せ所だよ。',
        highlight: 'シャンパンフルート',
